...
class DSGDNode:
    def __init__(self, node_id, lr=0.001, is_malicious=None, flip_percentage=None):
        self.node_id = node_id
        self.model = ResNet18().to(device)  # Move model to GPU
        self.optimizer = optim.Adam(self.model.parameters(), lr=lr)
        self.criterion = nn.CrossEntropyLoss()
        self.peers = []  # Two neighbors in a ring topology
        self.is_malicious = is_malicious  # Is this node malicious?
...
flip_percentage = 1  # Percentage of digits to flip in malicious nodes
